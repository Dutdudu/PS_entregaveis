...
class Satelite(Node):
    def __init__(self):
        ...
        self.declare_parameters(
            ...
            parameters=[
                ...
                ('nome_do_satelite',rclpy.Parameter.Type.STRING),
                ('raio_da_orbita',rclpy.Parameter.Type.INTEGER),
            ]
        )

        self.timer = self.create_timer(0.025,self.callback)
    ...
    def callback(self):
        ...
        self.parametro_string2 = self.get_parameter('nome_do_satelite').get_parameter_value().string_value
        t = TransformStamped()
